...
LevelMenuItem::LevelMenuItem(std::string name, Size visibleSize, int x2, int y2){
    float yPositions2[] = {0.22,0.452,0.68};
    float xPosition2 = .005;
    float yPosition = .68-0.452;
    float x = xPosition2;
    float y = yPosition * count;
    count++;
